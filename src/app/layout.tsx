...
export const metadata: Metadata = {
  ...
  description:
    "Watch AI browser agents compete head-to-head in real-time. Compare Browser-Use, Stagehand, Notte, and Smooth with ELO rankings and live benchmarks.",
  keywords: [
    "The Browser Arena",
    "browser agents",
    "AI browser agent",
  ...
  openGraph: {
    ...
    description:
      "Watch AI browser agents compete head-to-head in real-time. Compare Browser-Use, Stagehand, Notte, and Smooth with ELO rankings.",
