...
export default function DemoSessionPage() {
    ...
    const session = useQuery(api.queries.getDemoSession, { sessionId: sessionIdConvex });
    const agents = useQuery(api.queries.getDemoSessionAgents, { sessionId: sessionIdConvex });
