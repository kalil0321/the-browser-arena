...
export const MODEL_OPTIONS: Record<AgentType, ModelType[]> = {
    "browser-use": ["browser-use/bu-1.0", "google/gemini-2.5-flash", "google/gemini-2.5-pro", "google/gemini-3-pro-preview", "google/gemini-3-flash-preview", "openai/gpt-4.1", "openai/gpt-5.2", "openai/gpt-5-mini", "openai/gpt-5-nano", "anthropic/claude-haiku-4.5", "openrouter/moonshotai/kimi-k2-thinking"],
