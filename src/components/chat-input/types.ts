...
export const MODEL_OPTIONS: Record<AgentType, ModelType[]> = {
    ...
    "stagehand-bb-cloud": ["google/gemini-2.5-flash", "google/gemini-2.5-pro", "google/gemini-3-pro-preview", "openai/gpt-4.1", "anthropic/claude-haiku-4-5-20251001", "openai/computer-use-preview", "anthropic/claude-haiku-4-5-20251001", "anthropic/claude-sonnet-4-5-20250929"], // Commented out in UI for now
