...
import { Trophy, Plus, Swords, Medal, Plug } from "lucide-react";
            ...
            <SidebarContent className="flex flex-col gap-4 px-0 flex-1 overflow-y-auto">
                ...
                <div className="px-2">
                    <SidebarMenu>
                        ...
                        <SidebarMenuItem>
                            <SidebarMenuButton tooltip="Leaderboard" asChild>
                                <Link
                                    href="/leaderboard"
                                    prefetch={true}
                                    className="flex items-center gap-2 rounded-lg px-2 py-1.5 text-sm font-medium text-muted-foreground hover:bg-sidebar-muted hover:text-foreground transition-colors"
                        ...
                        <SidebarMenuItem>
                            <SidebarMenuButton tooltip="Battles" asChild>
                                <Link
                                    href="/battles"
                                    prefetch={true}
                                    className="flex items-center gap-2 rounded-lg px-2 py-1.5 text-sm font-medium text-muted-foreground hover:bg-sidebar-muted hover:text-foreground transition-colors"
                                >
                                    ...
                                    {!isCollapsed && <span>Battles</span>}
                                </Link>
                            </SidebarMenuButton>
                        </SidebarMenuItem>
                        <SidebarMenuItem>
                            <SidebarMenuButton tooltip="WebMCP" asChild>
                                <Link
                                    href="/webmcp"
                                    prefetch={true}
                                    className="flex items-center gap-2 rounded-lg px-2 py-1.5 text-sm font-medium text-muted-foreground hover:bg-sidebar-muted hover:text-foreground transition-colors"
