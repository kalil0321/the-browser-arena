...
export function AgentConfigDialog({ agentConfig, open, onOpenChange, onSave }: AgentConfigDialogProps) {
    ...
    const isBrowserUse = agentConfig.agent === "browser-use" || agentConfig.agent === "browser_use" || agentConfig.agent === "browser-use-cloud";
    const isStagehand = agentConfig.agent === "stagehand" || agentConfig.agent === "stagehand-bb-cloud" || agentConfig.agent === "stagehand-cloud";
