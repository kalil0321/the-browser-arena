                ...
                <div className="border border-gray-200 dark:border-border rounded-lg overflow-hidden">
                    ...
                    <div className="p-4 space-y-2 max-h-96 overflow-y-auto">
                        {agentResult.output.map((item: any, index: number) => {
                            ...
                            return (
                                <div key={index} className="group relative flex items-start gap-3 p-4 bg-white dark:bg-card rounded-lg border border-gray-200 dark:border-border hover:border-gray-300 dark:hover:border-border transition-all">
                                    <div className="shrink-0 w-7 h-7 rounded-full bg-gray-200 dark:bg-muted flex items-center justify-center text-xs font-bold text-gray-800 dark:text-gray-100">
                                        {index + 1}
                                    </div>
